...
export async function transformQuestBook(): Promise<void> {
	...
	transformKeyPairs(questBookNormal["questLines:9"], "normal", "line", lines, lineID);

	// Normal Mode Quests themselves.
	transformKeyPairs(questBookNormal["questDatabase:9"], "normal", "db", lines, questID);

	lines.push("# Expert Quest Lang Entries:", "");

	// Expert Mode Quest lines.
	transformKeyPairs(questBookExpert["questLines:9"], "expert", "line", lines, lineID);

	// Expert Mode Quests themselves.
	transformKeyPairs(questBookExpert["questDatabase:9"], "expert", "db", lines, questID);
